...
exports.ArtemisGlobals = void 0;
exports.initializeArtemisGlobals = initializeArtemisGlobals;
exports.getArtemisGlobals = getArtemisGlobals;
...
class ArtemisGlobals {
    ...
    loadArtemisGlobals() {
        ...
        if (this.artemisDir === null) {
            ...
            (0, iconSets_1.parseIconSet)(path.join(this.artemisDir, "data", "graphics", "grid-icon-sheet.png"), 128, false);
...
exports.ArtemisGlobals = ArtemisGlobals;
let globals;
// sleep(100).then(()=>{
// 	globals = new Globals();
// })
async function initializeArtemisGlobals() {
...
//# sourceMappingURL=artemisGlobals.js.map